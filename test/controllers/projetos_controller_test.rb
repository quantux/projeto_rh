...
class ProjetosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create projeto" do
    assert_difference('Projeto.count') do
      post projetos_url, params: { projeto: { descricao: @projeto.descricao, empresa_id: @projeto.empresa_id, nome: @projeto.nome } }
    end
  ...
  test "should update projeto" do
    patch projeto_url(@projeto), params: { projeto: { descricao: @projeto.descricao, empresa_id: @projeto.empresa_id, nome: @projeto.nome } }
